...
class TelechatAttention(nn.Module):
    ...
    def forward(
        ...
        # print("qkv dtype: ", value_layer.dtype)  # torch.float32
...
class TelechatForCausalLM(TelechatPreTrainedModel):
    ...
    def build_inputs_for_chat(self, tokenizer, question, history, generation_config, usr_id, bot_id):
        ...
        # ### 12b
        # input_tokens = [usr_id] + q_token["input_ids"][-build_max_length + 1:] \
        #                + [generation_config.eos_token_id] + [bot_id]
        ...
        while len(qa_history) != 0:
            ...
            if message["role"] == "user":
                ...
                # ### 12b
                # tokens = [usr_id] + message["input_ids"] + [generation_config.eos_token_id]
